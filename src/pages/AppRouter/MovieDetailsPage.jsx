...
function MovieDetailsPage() {
    ...
    return (
        <>
            ...
            {/* Grand ecran */}
            <div className="relative hidden lg:block min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(https://image.tmdb.org/t/p/original/${movieDetails?.backdrop_path || movieDetails?.poster_path})` }}>
                <div className="absolute inset-0 bg-black opacity-85"></div>
                <div className="relative z-10 flex items-center justify-center h-full text-white">
                            ...
                            <div className="flex flex-col gap-16">
                                <div className="flex flex-col gap-14">
                                    <div className="max-w-6xl mx-auto">
                                        <img src={`https://image.tmdb.org/t/p/original/${movieDetails?.backdrop_path || movieDetails?.poster_path}`} alt={`${movieDetails?.title} backdrop`} />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-6 gap-4">
                                        {similarMovies.map((simov, index) => (
                                            <Link to={`/movie-details?id=${simov.id}`} key={simov.id} className="relative w-full h-64 bg-gray-600">
                                                <img src={`https://image.tmdb.org/t/p/original/${simov.backdrop_path}`} alt={`${simov.title} backdrop`} className="w-full h-full object-cover" />
