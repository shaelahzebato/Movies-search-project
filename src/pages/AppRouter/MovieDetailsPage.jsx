...
import detailbg from '../../images/Detail-film–1.png'
...
function MovieDetailsPage() {
    ...
    return (
        <>
            {/* Petit ecran */}
            <div className="lg:hidden h-auto text-white p-4 bg-no-repeat" style={{backgroundImage:`url(${detailbg})`}}>
                <NavBar/>
                <div className="container mx-auto py-10">
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="max-w-full h-[400px] w-full m-auto py-8 relative group">
                                ...
                                <div className="flex justify-center py-2 absolute bottom-0 left-0 right-0">
                                    ...
                                    <div key={slideIndex} onClick={() => setCurrentIndex(slideIndex)} className={`cursor-pointer w-2 h-2 rounded-full mx-1 ${ currentIndex === slideIndex ? 'bg-white' : 'bg-gray-400' }`}>
                                        <img src={`${imgBase}/${simov?.backdrop_path}`} alt="" />
                                    </div>
                                    ))}
                                </div>
                            </div>
            ...
            {/* Grand ecran */}
            <div className="max-lg:hidden h-auto text-white p-4" style={{backgroundImage:`url(${detailbg})`}}>
                <NavBar/>
                <div className="container mx-auto py-10">
