...
import Tooltip from '@mui/material/Tooltip'; // Assurez-vous de cette importation
...
function MovieDetailsPage() {
    ...
    const prevSlide = () => {
        setCurrentIndex((prevIndex) => (prevIndex === 0 ? similarMovies.length - 1 : prevIndex - 1));
    };

    const nextSlide = () => {
        setCurrentIndex((prevIndex) => (prevIndex === similarMovies.length - 1 ? 0 : prevIndex + 1));
    };

    return (
        <>
            <div className="relative min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(${imgBase}/${movieDetails?.backdrop_path || movieDetails?.poster_path})` }}>
                        ...
                        <div className="flex flex-col gap-10">
                            <div className="grid grid-cols-1 gap-8">
                                <div className="flex flex-col gap-6">
                                    ...
                                    <img src={`${imgBase}/${movieDetails?.backdrop_path || movieDetails?.poster_path}`} alt={movieDetails?.title} className="w-full h-auto" />
                                </div>
                                ...
                                <ul className="flex gap-4 relative">
                                    ...
                                    <Tooltip title="Ajouter aux favoris" placement="top">
                                        <li className='text-2xl rounded-full p-2 bg-black/50 hover:bg-white/90 duration-500 ease-out border border-gray-700 font-semibold text-orange-500 cursor-pointer'>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="relative max-w-full h-[300px] w-full m-auto py-8">
                                    <div className="relative">
                                        ...
                                        <div className="absolute top-1/2 -translate-y-1/2 right-0 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer" onClick={nextSlide}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="m5.25 19.5 7.5-7.5-7.5-7.5m6 15L18.75 12l-7.5-7.5" />
                                            </svg>
                                        </div>
                                        <div style={{ backgroundImage: `url(${imgBase}/${similarMovies[currentIndex]?.backdrop_path})` }} className="w-full h-full bg-center bg-cover duration-500 rounded-lg"></div>
                                        <Link to={`/movie-details?id=${similarMovies[currentIndex]?.id}`} className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 rounded-lg">
...
// import NavBar from '../../components/NavBar/NavBar';
// import { Link, useSearchParams } from 'react-router-dom';
// import Tooltip from '@mui/material/Tooltip'; // Assurez-vous d'installer @mui/material pour les tooltips
...
//                                         </li>
//                                     </Tooltip>
//                                     <Tooltip title="Ajouter aux favoris" arrow>
//                                         <li className='text-2xl rounded-full p-2 bg-black/50 hover:bg-white/90 duration-500 ease-out border border-gray-700 font-semibold text-orange-500 cursor-pointer'>
//                                             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
//                                                 <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
//                                             </svg>
...
//             <div className="hidden lg:block relative min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(${imgBase}/${movieDetails?.backdrop_path || movieDetails?.poster_path})` }}>
//                 <div className="absolute inset-0 bg-black opacity-60"></div>
//                 <div className="relative z-10 flex items-center justify-center h-full text-white">
//                     <div className="container mx-auto py-10 px-4">
//                         <NavBar />
...
//                                 <img src={`${imgBase}/${movieDetails?.backdrop_path || movieDetails?.poster_path}`} alt={movieDetails?.title} className="w-full h-auto rounded-lg" />
...
//                                 <h2 className='text-2xl font-semibold mb-4'>Films similaires</h2>
//                                 <div className="relative max-w-full h-[300px] w-full">
//                                     <div className="relative">
//                                         <div className="absolute top-1/2 -translate-y-1/2 left-0 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer" onClick={prevSlide}>
//                                             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
//                                                 <path strokeLinecap="round" strokeLinejoin="round" d="m18.75 4.5-7.5 7.5 7.5 7.5m-6-15L5.25 12l7.5 7.5" />
