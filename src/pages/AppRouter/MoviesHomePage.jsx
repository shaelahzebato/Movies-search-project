...
//Regeler quelque petits soucis ici!
function MovieHomePage() {
    ...
    const userIsActive = (e) => {
        ...
        else if(isAuthenticated && !movieTitle) {
            newErrors.moviename = "Le nom d'un film est requis.";
            setErrors(newErrors);
        }
        else if(isAuthenticated && movieTitle.length < 3) {
    ...
    return (
        ...
        //                 <input type="text" value={movieTitle} onChange={handleChange} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-4 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Entrez le nom d'un film..."/>
