        ...
        <div className='container mx-auto'>
                ...
                <nav className="flex justify-between items-center py-4">
                    ...
                    <div className="lg:hidden text-orange-500 cursor-pointer">
                        <div className="relative inline-block">
                            <button onClick={() => setIsOpen(!isOpen)} className="inline-flex justify-center w-full rounded-md shadow-sm px-4 py-2 text-sm font-medium text-orange-500 focus:outline-none ">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                                </svg>
                            </button>
                            {isOpen && (
                                <div className={`fixed top-0 right-0 w-full h-32 flex items-center justify-end px-10 bg-black text-white transform transition-transform duration-300 ease-in-out z-40`}>
                                    <div className="flex flex-col items-end justify-center gap-6">
                                        ...
                                        <div className="flex items-center">
                                            <div className="relative inline-block text-left">
                                                <button onClick={() => setIsReOpen(!isReOpen)} className="inline-flex justify-center w-full rounded-md shadow-sm px-4 py-2 text-sm font-medium text-orange-500 focus:outline-none ">
                                                ...
                                                {isReOpen && (
                                                    <div className="origin-top-right absolute right-0 mt-2 w-56 rounded-sm shadow-lg text-white bg-black bg-opacity-75 ring-1 ring-black ring-opacity-5 focus:outline-none">
            ...
            :
                ...
                <nav className="flex justify-between items-center py-4">
                    ...
                    <div className="max-lg:hidden flex justify-between items-center gap-4 uppercase">
